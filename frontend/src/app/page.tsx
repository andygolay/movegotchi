...
function Header() {
  return (
    <header className="sm:px-4 md:sticky top-0 z-10 flex justify-between items-center md:px-6 py-4 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 w-full gap-2 text-white border-2 border-black shadow-[4px_4px_0px_#000000]">
      ...
      <ConnectButton
        className="px-8 py-4 font-pixel bg-gradient-to-br from-[#308DEF] to-[#9036EA] text-white border-2 border-black shadow-[4px_4px_0px_#000000] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] active:translate-x-[2px] active:translate-y-[2px] transition-all"
      />
    </header>
  );
}
